...
# Heredo  mail.tread y mail.activity.mixin para activar el chatter, hay que modificar la vista
    ...
    x_contacto = fields.Char ('Ccontacto')            
    # x_contacto = fields.Many2one('res.partner',domain=[('is_patient','=',True)],string="Patient", required= False, string="Nombre del paciente)
